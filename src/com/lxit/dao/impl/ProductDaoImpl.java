...
public class ProductDaoImpl extends BaseDaoImpl<Product, String> implements ProductDao {
    ...
    public List<Product> getProductList(ProductCategory productCategory) {
        ...
        return getSession().createQuery(hql).setParameter(0, true).setParameter(1, productCategory.getPath() + "%")
                .list();
    }
    ...
    public Pager getProductPager(ProductCategory productCategory, Pager pager) {
        ...
        detachedCriteria.add(Restrictions.or(Restrictions.eq("productCategory", productCategory),
                Restrictions.like("productCategory.path", productCategory.getPath() + "%")));
    ...
    public List<Product> getBestProductList(ProductCategory productCategory, int maxResults) {
        ...
        return getSession().createQuery(hql).setParameter(0, true).setParameter(1, true)
                .setParameter(2, productCategory).setParameter(3, productCategory.getPath() + "%").list();
    }
    ...
    public Long getStoreAlertCount() {
        ...
        return (Long) getSession().createQuery(hql).setParameter(0, true)
                .setParameter(1, SystemConfigUtil.getSystemConfig().getStoreAlertCount()).uniqueResult();
    }
