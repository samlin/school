...
import com.lxit.common.JCaptchaEngine;
...
import com.lxit.service.MailService;
...
public class MemberAction extends BaseShopAction {
    ...
    public String login() throws Exception {
        ...
        // 写入会员登录Cookie
        Cookie loginMemberUsernameCookie = new Cookie(Member.LOGIN_MEMBER_USERNAME_COOKIE_NAME, URLEncoder.encode(
    ...
    public String ajaxRegister() throws Exception {
        ...
        // 写入会员登录Cookie
        Cookie loginMemberCookie = new Cookie(Member.LOGIN_MEMBER_USERNAME_COOKIE_NAME, URLEncoder.encode(member
                .getUsername().toLowerCase(), "UTF-8"));
    ...
    public String passwordModify() throws Exception {
        ...
        if (persistent == null
                || StringUtils.equalsIgnoreCase(persistent.getPasswordRecoverKey(), passwordRecoverKey) == false) {
        ...
        Date passwordRecoverKeyExpiredDate = DateUtils.addMinutes(passwordRecoverKeyBuildDate,
