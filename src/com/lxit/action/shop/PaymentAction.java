...
import com.lxit.bean.TenpayConfig;
import com.lxit.bean.TenpayConfig.TenpayType;
...
@InterceptorRefs({ @InterceptorRef(value = "token", params = { "excludeMethods", "confirm,tenpayReturn" }),
...
public class PaymentAction extends BaseShopAction {
    ...
    public String tenpayReturn() throws Exception {
        ...
        if (StringUtils.equals(cmdno, "1")) {
            ...
            if (!StringUtils.equals(sign, DigestUtils.md5Hex(paymentConfigService.buildParameterString(parameterMap))
                    .toUpperCase())) {
