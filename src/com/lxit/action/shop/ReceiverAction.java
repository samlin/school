...
public class ReceiverAction extends BaseShopAction {
    ...
    public String add() {
        ...
        if (receiverSet != null && Receiver.MAX_RECEIVER_COUNT != null
    ...
    // 收货地址保存
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "receiver.name", message = "收货人不允许为空!"),
            ...
            @RequiredStringValidator(fieldName = "receiver.zipCode", message = "邮编不允许为空!") }, requiredFields = { @RequiredFieldValidator(fieldName = "receiver.isDefault", message = "是否默认不允许为空!") })
