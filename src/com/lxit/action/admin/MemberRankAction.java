...
public class MemberRankAction extends BaseAdminAction {
    ...
    // 保存
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "memberRank.name", message = "等级名称不允许为空!") }, requiredFields = {
            ...
            @RequiredFieldValidator(fieldName = "memberRank.isDefault", message = "是否为默认等级不允许为空!") }, intRangeFields = { @IntRangeFieldValidator(fieldName = "memberRank.point", min = "0", message = "所需积分只允许为正整数或零!") })
    ...
    public String update() {
        ...
        BeanUtils
                .copyProperties(memberRank, persistent, new String[] { "id", "createDate", "modifyDate", "memberSet" });
