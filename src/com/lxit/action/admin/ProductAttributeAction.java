...
public class ProductAttributeAction extends BaseAdminAction {
    ...
    @Validations(requiredStrings = {
            ...
            @RequiredStringValidator(fieldName = "productAttribute.productType.id", message = "商品类型不允许为空!") }, requiredFields = {
            ...
            @RequiredFieldValidator(fieldName = "productAttribute.orderList", message = "排序不允许为空!") }, intRangeFields = { @IntRangeFieldValidator(fieldName = "productAttribute.orderList", min = "0", message = "排序必须为零或正整数!") })
    @InputConfig(resultName = "error")
    public String save() {
        ProductAttribute pa = productAttributeService.getProductAttribute(productAttribute.getProductType(),
        ...
        if (productAttribute.getAttributeType() == AttributeType.select
            ...
            while (iterator.hasNext()) {
                String attributeOption = iterator.next();
