...
public class DeliveryTypeAction extends BaseAdminAction {
    ...
    // 保存
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "deliveryType.name", message = "配送方式名称不允许为空!") }, requiredFields = {
            ...
            @RequiredFieldValidator(fieldName = "deliveryType.orderList", message = "排序不允许为空!") }, intRangeFields = { @IntRangeFieldValidator(fieldName = "deliveryType.orderList", min = "0", message = "排序必须为零或正整数!") })
    ...
    public String update() {
        ...
        BeanUtils.copyProperties(deliveryType, persistent, new String[] { "id", "createDate", "modifyDate", "orderSet",
                "shippingSet", "reshipSet" });
