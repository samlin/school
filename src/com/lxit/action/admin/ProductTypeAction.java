...
public class ProductTypeAction extends BaseAdminAction {
    ...
    // 保存
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "productType.name", message = "商品类型不允许为空!") })
    ...
    public String update() {
        ...
        BeanUtils.copyProperties(productType, persistent, new String[] { "id", "createDate", "modifyDate",
                "productAttributeList", "productSet" });
