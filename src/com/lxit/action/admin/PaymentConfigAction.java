...
import com.lxit.entity.PaymentConfig.PaymentFeeType;
...
public class PaymentConfigAction extends BaseAdminAction {
    ...
    // 保存
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "paymentConfig.name", message = "支付方式名称不允许为空！") }, requiredFields = {
            ...
            @RequiredFieldValidator(fieldName = "paymentConfig.orderList", message = "排序不允许为空！") }, intRangeFields = { @IntRangeFieldValidator(fieldName = "paymentConfig.orderList", min = "0", message = "排序必须为零或正整数！") })
