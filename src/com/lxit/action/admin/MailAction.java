...
public class MailAction extends BaseAdminAction {
    ...
    // 发送SMTP测试邮件
    @Validations(requiredStrings = { @RequiredStringValidator(fieldName = "smtpFromMail", message = "发件人邮箱不允许为空!"),
            ...
            @RequiredStringValidator(fieldName = "smtpToMail", message = "收件人邮箱不允许为空!") }, requiredFields = { @RequiredFieldValidator(fieldName = "smtpPort", message = "SMTP服务器端口不允许为空!") }, intRangeFields = { @IntRangeFieldValidator(fieldName = "smtpPort", min = "0", message = "SMTP端口必须为零正整数!") }, emails = {
