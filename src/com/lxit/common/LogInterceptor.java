...
import com.lxit.action.admin.BaseAdminAction;
...
public class LogInterceptor extends AbstractInterceptor {
	...
	public static final String[] excludeActionClassNames = new String[] {"com.lxit.action.admin.InstallAction"};// 需要排除的Action类名称
