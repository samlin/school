    ...
    setFormFieldFactory(new DefaultFieldFactory() {
      ...
      public Field createField(Item item, Object propertyId, Component uiContext) {
        ...
        if (propertyId.equals("postalCode")) {
          ...
          /*
           * We do not want to display "null" to the user when the field is
           * empty
           */
  ...
  public void buttonClick(ClickEvent event) {
    ...
    if (source == save) {
      ...
      if (newContactMode) {
        ...
        /*
         * We must update the form to use the Item from our datasource as we are
         * now in edit mode (no longer in add mode)
         */
