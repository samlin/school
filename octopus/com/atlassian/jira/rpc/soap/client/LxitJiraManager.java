...
public class LxitJiraManager {
    ...
    private static void createStudents() {
        ...
        for (Iterator<Student> iterator = studentList.iterator(); iterator.hasNext();) {
            ...
            System.out.println("�ɹ������û�:" + student.getName() + "��¼��Ϊ:" + pinyinName);
        }
    ...
    public static void createSingleUser(Student student) {
        ...
        System.out.println("�ɹ������û�:" + student.getName() + "��¼��Ϊ:" + loginName);
    ...
    public static RemotePermissionScheme createDayLogPermissionsAndScheme(String classId) {
        ...
        System.out.println("创建的权限名字是:" + getDayLogPermissionSchemeNameFromClassId(classId) + "");
        try {
    ...
    public static void createJiraStudentsToGroup(List<com.lxit.entity.Student> classStudentList, String className)
            throws Exception, RemoteValidationException, RemoteAuthenticationException,
            com.atlassian.jira.rpc.soap.client.RemoteException, RemoteException {
        String pinyinName;
        RemoteUser user = null;
        RemoteGroup group;
        group = j.getGroup(a, className);
        for (Iterator<com.lxit.entity.Student> iterator = classStudentList.iterator(); iterator.hasNext();) {
            ...
            j.addUserToGroup(a, group, user);
            System.out.println("创建学生:" + student.getName() + "拼音名为:" + pinyinName);
        }
