...
public class ClassNameDaoImplFreemarker extends BaseGenerateFreemarker implements Observer {

    public static final String REVISION = "$Revision: 1.16 $";

    private static final Log log = LogFactory.getLog(ClassNameDaoImplFreemarker.class);
     ...
     */
    public ClassNameDaoImplFreemarker(GeneralSubject subject) {
        subject.attach(this);
    }
    ...
    protected String getTemplateName() {
        return "ClassNameDaoImpl.ftl";
    }

    @Override
    protected void setSrcFileName() {
        srcFileName = srcPath + "/src/" + replaceString(basePackageName, ".", "/") + "/dao/impl/" + className
                + "DaoImpl.java";
    ...
    protected void setupOutFolder() throws Exception {
        ...
        Thread.sleep(200);
        file = new File(folderName + "/dao/impl");
        if (!file.exists()) {
            file.mkdir();
        }
    }
