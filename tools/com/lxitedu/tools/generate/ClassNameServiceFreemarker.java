...
public class ClassNameServiceFreemarker extends BaseGenerateFreemarker implements Observer {

    public static final String REVISION = "$Revision: 1.16 $";

    private static final Log log = LogFactory.getLog(ClassNameServiceFreemarker.class);
     ...
     */
    public ClassNameServiceFreemarker(GeneralSubject subject) {
        subject.attach(this);
    }
    ...
    protected String getTemplateName() {
        return "ClassNameService.ftl";
    }

    @Override
    protected void setSrcFileName() {
        srcFileName = srcPath + "/src/" + replaceString(basePackageName, ".", "/") + "/service/" + className
                + "Service.java";
    ...
    protected void setupOutFolder() throws Exception {
        ...
        Thread.sleep(200);
        file = new File(folderName + "/service");
        if (!file.exists()) {
            file.mkdir();
        }
    }
